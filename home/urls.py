...
from home.views import inicio, crear_estudiante, lista_estudiantes, VistaDetalleEstudiante, VistaModificarEstudiante, VistaEliminarEstudiante 
...
urlpatterns = [
    ...
    path('estudiantes/<int:pk>/eliminar-estudiante/', VistaEliminarEstudiante.as_view(), name='eliminar_estudiante'),
]